...
export function ForgotPasswordLink() {
  return (
    <div className="p-12 border-2 border-dashed border-border rounded-3xl text-center bg-muted/30">
      ...
      <h3 className="text-xl font-bold mb-2">ForgotPasswordLink</h3>
      <p className="text-sm text-muted-foreground max-w-xs mx-auto">
        No template found for this intent. Create a file at <code>cli/templates/forgot-password-link.tsx</code> to customize.
      </p>
    </div>
  );
}